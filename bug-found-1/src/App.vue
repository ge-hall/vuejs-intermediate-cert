...
function saveMovie(data) {
  ...
  console.log(`id: ${data.id}, isNew: ${isNew}`);
  if (isNew) {
    addMovie(data);
  } else {
    updateMovie(data);
...
function updateMovie(data) {
  // issure here is that we are mapping over the entire array but returning data.
  // therefore setting each existing movie to the edited form.
